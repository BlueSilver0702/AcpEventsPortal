		...
		<header id="header">
			<div class="container">
				<div class="header-box">
					<h1 class="logo small align-left"><a href="<?php echo get_page_link((empty($_REQUEST['acpredir']) ? 41 : $_REQUEST['acpredir'])); ?>">Advantage Care Physicians ADVANTAGECARE IN YOUR NEIGHBORHOOD</a></h1>
				</div>
			</div>
		</header>
		<!--header ends-->